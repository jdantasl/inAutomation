# language: pt
  ...
  @test
  Cenario: Acesso à página Busca CEP
  Dado que eu esteja na pagina "Você"
  Quando eu clicar em "Busca CEP"
  Entao a página "Busca CEP - Endereço" deverá ser carregada

	@pend
	Cenario: Exibindo minha primeira consulta
  Dado que eu esteja na pagina "Busca CEP - Endereço"
  Quando eu digitar "06823010"
  E eu clicar em "Buscar"
  Entao a página exibe "DADOS ENCONTRADOS COM SUCESSO."
  E a página exibe 
